...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function resetPanelSelection() {
        selectedEvent = null;
        eventSummary.innerHTML = '<h4>Resumen del Evento</h4><p>Haz clic en un evento de la lista para ver su detalle.</p>';
        editEventBtn.disabled = true;
        deleteEventBtnPanel.disabled = true;
    ...
    if (calendarEl) {
        calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(info) {
                ...
                deleteEventBtnPanel.disabled = false;
